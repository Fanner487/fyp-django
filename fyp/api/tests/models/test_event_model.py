...
class EventModelTestCase(TestCase):
    ...
    def test_event_create_user_update(self):
        ...
        self.assertNotEqual(event.organiser, "user1")
        self.assertNotEqual(event.event_name, "test")
        self.assertNotEqual(event.location, "test")
        self.assertNotEqual(event.start_time, '2050-01-29T12:00:00')
        self.assertNotEqual(event.finish_time, '2050-01-29T12:30:00')
        self.assertNotEqual(event.sign_in_time, '2050-01-29T12:00:00')
        self.assertNotEqual(event.attendees, ['user2', 'user3', 'user4'])
        self.assertIsNone(event.attending)
